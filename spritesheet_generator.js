 ...
 * @returns {any}
 */
export function generate_spritesheet(images, canvas_width) {
    const ret = wasm.generate_spritesheet(images, canvas_width);
    return ret;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('spritesheet_generator_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
